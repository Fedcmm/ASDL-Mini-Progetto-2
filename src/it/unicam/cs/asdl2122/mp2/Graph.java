...
public abstract class Graph<L> {
     ...
     * 
     * @param label l'etichetta del nuovo nodo da aggiungere
     * @return true se il nodo è stato aggiunto, false altrimenti cioè se il
     *         nodo è già presente
     *
     ...
     *
     * @throws IllegalArgumentException se il nodo passato non esiste in questo grafo
     * @throws NullPointerException se il nodo passato è null
     ...
     * 
     * @param node il nodo da restituire
     ...
     * nodo dato. L'indice sarà nell'intervallo <code>[0, this.nodeCount() - 1]</code>.
     * Questa funzionalità è tipicamente disponibile se il grafo è rappresentato con una
     * matrice di adiacenza. Tale indice può anche essere usato per identificare i nodi
     * in strutture dati esterne come array o liste che contengono informazioni aggiuntive
     * calcolate, ad esempio, da un algoritmo sul grafo.
     * 
     * Questa operazione è opzionale.
     * 
     * @param node il nodo di cui restituire l'indice
     * @return un indice unico nell'intervallo <code>[0, this.nodeCount() - 1]</code>
     *         attualmente associato al nodo {@code node}. L'indice può cambiare se il grafo viene
     ...
     * {@code label} non esiste in questo grafo
     * @throws UnsupportedOperationException se questa operazione non è
     * supportata dall'implementazione di questo grafo
     */
     ...
     * 
     * @param node1 nodo sorgente del nuovo arco in caso di grafo orientato,
     *              altrimenti un nodo del nuovo arco
     * @param node2 nodo destinazione del nuovo arco in caso di grafo
     ...
     * orientato l'arco sarà orientato, altrimenti sarà un arco non orientato.
     * 
     * @param node1 nodo sorgente del nuovo arco in caso di grafo
     *              orientato, altrimenti un nodo del nuovo arco
     * @param node2 nodo destinazione del nuovo arco in caso di grafo
     *              orientato, altrimenti un nodo del nuovo arco
     * @param weight il peso da associare all'arco
     * @return true se l'arco è stato inserito, false se un arco esattamente
     *         uguale già esiste
     *
     * @throws NullPointerException se almeno uno dei due nodi passati è nullo
     ...
     * 
     * @param label1 l'etichetta del nodo sorgente del nuovo arco in caso di
     *               grafo orientato, altrimenti l'etichetta di un nodo del nuovo arco
     * @param label2 l'etichetta del nodo destinazione del nuovo arco in
     *               caso di grafo orientato, altrimenti l'etichetta di un
     *               nodo del nuovo arco
     * @return true se l'arco è stato inserito, false se un arco esattamente
     *         uguale già esiste
     *
     * @throws NullPointerException se una delle etichette passate è nulla
     * @throws IllegalArgumentException se almeno una delle due etichette
     ...
     * passati non corrisponde a nessun nodo o è fuori dai limiti dell'intervallo
     * <code>[0, this.nodeCount() - 1]</code>
     * @throws UnsupportedOperationException se questa operazione non è
     * supportata dall'implementazione di questo grafo
     */
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo sorgente del nuovo arco in caso di
     *          grafo orientato, altrimenti l'indice di uno dei nodi del nuovo arco
     * @param j l'indice del nodo destinazione del nuovo arco in caso
     *          di grafo orientato, altrimenti l'indice di uno dei nodi del nuovo arco
     * @param weight il peso da associare all'arco
     * @return true se l'arco è stato inserito, false se un arco esattamente
     *         uguale già esiste
     *
     ...
     * 
     * @throws IllegalArgumentException se l'arco non esiste in questo grafo
     * @throws IllegalArgumentException se almeno uno dei due nodi
     * specificati nell'arco non esiste
     * @throws NullPointerException se l'arco passato è nullo
     * @throws UnsupportedOperationException se l'implementazione del grafo
     ...
     * Questa operazione è opzionale.
     * 
     * @param node1 il nodo sorgente dell'arco da rimuovere nel caso di
     *              grafo orientato, altrimenti uno dei due nodi dell'arco da rimuovere
     * @param node2 il nodo destinazione dell'arco da rimuovere nel caso di
     *              grafo orientato, altrimenti uno dei due nodi dell'arco da rimuovere
     *
     * @throws IllegalArgumentException se l'arco non esiste nel grafo
     * @throws IllegalArgumentException se almeno uno dei due nodi passati non esiste
     * @throws NullPointerException se almeno uno dei due nodi passati è nullo
     * @throws UnsupportedOperationException se l'implementazione del grafo
     * non supporta questa operazione
     */
     ...
     * Questa operazione è opzionale.
     * 
     * @param label1 l'etichetta del nodo sorgente dell'arco da rimuovere
     *               nel caso di grafo orientato, altrimenti l'etichetta di
     *               uno dei due nodi dell'arco da rimuovere
     * @param label2 l'etichetta del nodo destinazione dell'arco da
     *               rimuovere nel caso di grafo orientato, altrimenti
     *               l'etichetta di uno dei due nodi dell'arco da rimuovere
     *
     * @throws IllegalArgumentException se l'arco non esiste nel grafo
     * @throws IllegalArgumentException se almeno una delle due
     * etichette passate non esiste nel grafo
     * @throws NullPointerException se almeno una delle due etichette passate è nulla
     * @throws UnsupportedOperationException se l'implementazione del grafo
     * non supporta questa operazione
     */
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo sorgente dell'arco da rimuovere nel caso
     *          di grafo orientato, altrimenti l'etichetta di uno dei due
     *          nodi dell'arco da rimuovere
     * @param j l'indice del nodo destinazione dell'arco da rimuovere nel
     ...
     *
     * @throws NullPointerException se almeno uno dei due nodi passati è null
     * @throws IllegalArgumentException se almeno uno dei due nodi passati
     * non esiste nel grafo
     */
    public abstract GraphEdge<L> getEdge(GraphNode<L> node1, GraphNode<L> node2);
     ...
     * secondo.
     * 
     * @param label1 l'etichetta del primo nodo
     * @param label2 l'etichetta del secondo nodo
     ...
     *         qualsiasi ordine
     *
     * @throws NullPointerException se almeno una delle due etichette passate è null
     * @throws IllegalArgumentException se almeno una delle due etichette
     * passate non è presente in nessun nodo di questo grafo
     */
     ...
     * collegati da un arco uscente dal nodo in questione.
     * 
     * @param label l'etichetta del nodo di cui cercare i nodi adiacenti
     * @return l'insieme di tutti i nodi adiacenti al nodo con etichetta data
     * 
     * @throws IllegalArgumentException se l'etichetta passata non esiste in
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo di cui cercare i nodi adiacenti
     ...
     * 
     * @param node il nodo di cui cercare i nodi predecessori
     ...
     * 
     * @param label l'etichetta del nodo di cui cercare i nodi predecessori
     * @return l'insieme di tutti i nodi collegati tramite un arco entrante al
     *         nodo con etichetta data
     *
     * @throws UnsupportedOperationException se il grafo su cui il metodo è
     * chiamato non è orientato
     * @throws IllegalArgumentException se l'etichetta passata non
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo di cui cercare i nodi predecessori
     * @return l'insieme di tutti i nodi collegati tramite un arco entrante al
     ...
     * gli archi uscenti.
     * 
     * @param label l'etichetta del nodo di cui sono richiesti gli archi connessi
     ...
     *         grafo orientato)
     *
     * @throws IllegalArgumentException se il nodo con l'etichetta passata non esiste
     * @throws NullPointerException se l'etichetta passata è nulla
     */
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo di cui sono richiesti gli archi connessi
     ...
     * Questa operazione è opzionale.
     * 
     * @param label l'etichetta del nodo di cui determinare tutti gli archi entranti
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo di cui determinare tutti gli archi entranti
     * @return un insieme contenente tutti gli archi entranti nel nodo con
     ...
     * 
     * @param label l'etichetta del nodo di cui calcolare il grado
     ...
     * Questa operazione è opzionale.
     * 
     * @param i l'indice del nodo di cui calcolare il grado
